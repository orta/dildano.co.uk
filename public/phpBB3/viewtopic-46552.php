...
<div id="wrapcentre">
	...
	<br />
<div id="pageheader">
	<h2><a class="titles" href="viewtopic-7592.php">Fancy bits</a></h2>
...
<div id="pagecontent">
	...
	<tr>
		...
		<a href="posting-55927.php"><img src="styles/dildano/imageset/en/button_topic_new.gif" alt="Post new topic" title="Post new topic" /></a>&nbsp;<a href="posting-33780.php"><img src="styles/dildano/imageset/en/button_topic_reply.gif" alt="Reply to topic" title="Reply to topic" /></a>		</td>
			...
			<td class="gensmall" width="100%" align="right" nowrap="nowrap"><b><a href="#" onclick="jumpto(); return false;" title="Click to jump to page…">Go to page</a> <a href="viewtopic-33449.php">Previous</a>&nbsp;&nbsp;<a href="viewtopic-57355.php">1</a><span class="page-sep">, </span><strong>2</strong></b></td>
			</tr>
	</table>
	...
	<tr>
		<td class="cat">
			...
			<tr>
				...
				<a href="viewtopic-48189.php" title="Print view">Print view</a>				</td>
	...
	<tr class="row1">
			...
			<td width="100%" height="25">
				<table width="100%" cellspacing="0">
				<tr>
									<td class="gensmall" width="100%"><div style="float: left;">&nbsp;<b>Post subject:</b> Re: Fancy bits</div><div style="float: right;"><a href="viewtopic-25347.php#p191"><img src="styles/dildano/imageset/icon_post_target.gif" width="12" height="9" alt="Post" title="Post" /></a><b>Posted:</b> Fri Dec 04, 2009 4:41 pm&nbsp;</div></td>
				</tr>
				</table>
			</td>
		</tr>
			...
			<td valign="top">
				...
				<tr>
					<td>
						...
						<div class="postbody">how's this? hard to see it's a cheetah at that size, looks more like one of fearnley-whittingstall's woodlice. you may need to close your browser and run it again to see it the first time. also if said browser is IE6 or worse you're on your own.</div>
	...
	<tr class="row2">
			...
			<td width="100%" height="25">
				<table width="100%" cellspacing="0">
				<tr>
									<td class="gensmall" width="100%"><div style="float: left;">&nbsp;<b>Post subject:</b> Re: Fancy bits</div><div style="float: right;"><a href="viewtopic-13222.php#p194"><img src="styles/dildano/imageset/icon_post_target.gif" width="12" height="9" alt="Post" title="Post" /></a><b>Posted:</b> Sun Dec 06, 2009 10:46 am&nbsp;</div></td>
				</tr>
				</table>
			</td>
		</tr>
			...
			<td valign="top">
				...
				<tr>
					<td>
						...
						<div class="postbody">Brilliant! I thought I was asking for the impossible. I imagined that you had to suck off the guy that owns the internet to get something like that done. Who does own the internet?<br /><br />Anyway... looks great. Good work.</div>
	...
	<tr class="row1">
			...
			<td width="100%" height="25">
				<table width="100%" cellspacing="0">
				<tr>
									<td class="gensmall" width="100%"><div style="float: left;">&nbsp;<b>Post subject:</b> Re: Fancy bits</div><div style="float: right;"><a href="viewtopic-27382.php#p294"><img src="styles/dildano/imageset/icon_post_target.gif" width="12" height="9" alt="Post" title="Post" /></a><b>Posted:</b> Thu May 06, 2010 2:00 pm&nbsp;</div></td>
				</tr>
				</table>
			</td>
		</tr>
			...
			<td valign="top">
				...
				<tr>
					<td>
						...
						<div class="postbody">I like how it remembers me, when I log on.<br /><br />It's nice to be remembered.</div>
	...
	<tr align="center">
		<td class="cat"><form name="viewtopic" method="post" action="./viewtopic.php?f=3&amp;t=2&amp;start=10"><span class="gensmall">Display posts from previous:</span> <select name="st" id="st"><option value="0" selected="selected">All posts</option><option value="1">1 day</option><option value="7">7 days</option><option value="14">2 weeks</option><option value="30">1 month</option><option value="90">3 months</option><option value="180">6 months</option><option value="365">1 year</option></select>&nbsp;<span class="gensmall">Sort by</span> <select name="sk" id="sk"><option value="a">Author</option><option value="t" selected="selected">Post time</option><option value="s">Subject</option></select> <select name="sd" id="sd"><option value="a" selected="selected">Ascending</option><option value="d">Descending</option></select>&nbsp;<input class="btnlite" type="submit" value="Go" name="sort" /></form></td>
	</tr>
	</table>
