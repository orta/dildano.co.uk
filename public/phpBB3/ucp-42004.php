...
<title>DILDANO &bull; User Control Panel &bull; Register</title>
...
<div id="wrapcentre">
	...
	<br />
	<form method="post" action="./ucp.php?mode=register">

	<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<th height="25">DILDANO - Registration</th>
	</tr>
	<tr>
	...
	<br /><br /></span>
		...
		<input type="hidden" name="creation_time" value="1279728954" />
<input type="hidden" name="form_token" value="79e6ed938df3245fadec868a2b05064acbc5b7c2" />
	</form>
